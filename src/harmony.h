...
public: 
  ...
  VECTYPE Pr_b, theta, N_b, sigma, sigma_prior, all_lambda_dym_vec;
  arma::fvec lambda_range;
  ...
  // buffers
  MATTYPE _scale_dist, dist_mat, O, E, dir_prior, Phi_Rk, lambda_dym_mat; // N_k, N_kb, N_b, numerator, denominator, C;
